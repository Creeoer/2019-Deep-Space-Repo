...
public class MyVisionPipeline implements VisionPipeline {
	...
	@Override	public void process(Mat source0) {
		...
		double resizeImageWidth = 600.0;
		double resizeImageHeight = 450.0;
		int resizeImageInterpolation = Imgproc.INTER_CUBIC;
		resizeImage(resizeImageInput, resizeImageWidth, resizeImageHeight, resizeImageInterpolation, resizeImageOutput);

		// Step HSV_Threshold0:
		Mat hsvThresholdInput = resizeImageOutput;
		double[] hsvThresholdHue = {67.98561151079136, 125.45454545454544};
		double[] hsvThresholdSaturation = {7.434086627695381, 90.7169149105237};
		double[] hsvThresholdValue = {133.00359712230215, 255.0};
		...
		int cvErodeBordertype = Core.BORDER_REFLECT101;
